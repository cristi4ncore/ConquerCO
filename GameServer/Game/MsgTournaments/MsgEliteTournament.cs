            ...
            foreach (var tournament in EliteGroups)
            {
                ...
                if (tournament.GetReward(client, out Rank))
                {
                    ...
                    if (tournament.GroupTyp == GroupTyp.EPK_Lvl130Plus && Rank == 1)
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : on ElitePK and claimed 250K Cps .";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    if (tournament.GroupTyp == GroupTyp.EPK_Lvl130Plus && Rank == 2)
                    {
                        client.Player.ConquerPoints += 200000;
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : on ElitePK and claimed 200K Cps .";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    if (tournament.GroupTyp == GroupTyp.EPK_Lvl130Plus && Rank == 3)
                    {
                        client.Player.ConquerPoints += 150000;
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : on ElitePK and claimed 150K Cps";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    if (tournament.GroupTyp == GroupTyp.EPK_Lvl130Plus && Rank == 4)
                    {
                        client.Player.ConquerPoints += 100000;
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : on ElitePK and claimed 100K CPS.";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    if (tournament.GroupTyp == GroupTyp.EPK_Lvl130Plus && Rank == 5)
                    {
                        client.Player.ConquerPoints += 100000;
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : on ElitePK Tournament and claimed 100K CPS .";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    if (tournament.GroupTyp == GroupTyp.EPK_Lvl130Plus && Rank == 6)
                    {
                        client.Player.ConquerPoints += 100000;
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : on ElitePK  and claimed 100K CPS.";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    if (tournament.GroupTyp == GroupTyp.EPK_Lvl130Plus && Rank == 7)
                    {
                        client.Player.ConquerPoints += 100000;
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : on ElitePK and claimed 100K CPS .";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    if (tournament.GroupTyp == GroupTyp.EPK_Lvl130Plus && Rank == 8)
                    {
                        client.Player.ConquerPoints += 100000;
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : on ElitePK and claimed 100K CPS.";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
