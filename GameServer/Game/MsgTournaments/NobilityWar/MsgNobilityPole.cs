...
namespace DeathWish.Game.MsgTournaments
{
    public class MsgNobilityPole
    {
        ...
        public static void Start()
        {
            ...
            MsgSchedules.SendInvitation("NobilityPoleWar ", "Special Reward", 390, 320, 1002, 0, 500);
