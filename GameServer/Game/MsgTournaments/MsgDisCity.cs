...
namespace DeathWish.Game.MsgTournaments
{
    public class MsgDisCity
    {
        ...
        public void RewardDarkHorn(Client.GameClient client, ServerSockets.Packet stream)
        {
            ...
            client.Inventory.Add(stream, 3003235, 1);
            ...
            MsgSchedules.SendSysMesage("" + client.Player.Name + " has claimed the reward from DisCity.["+value+" Cps "+values+" Gold and 5PowerExpBalls, 2DBScrolls, 1StarDrill and 3000ChiPoints.]", MsgServer.MsgMessage.ChatMode.System, MsgServer.MsgMessage.MsgColor.red);
